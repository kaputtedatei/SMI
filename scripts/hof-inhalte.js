...
const HOF_DATA = [
    ...
    title: 'First Friend', 
    year: 2003,
    link: 'https://www.flickr.com/photos/factoryjoe/3552930548',
    images: ['2003.1.jpg'],
    desc: 'Tom Anderson, besser bekannt als „MySpace Tom“, wurde durch seine Rolle als Mitgründer von MySpace zur ersten ikonischen Figur sozialer Netzwerke. Jede neu erstellte MySpace-Seite hatte automatisch „Tom“ als ersten Freund, wodurch er symbolisch Teil jedes Profils wurde. Diese Praxis war weniger Marketingstrategie als ein Versuch, neuen Nutzer:innen ein Gefühl von Zugehörigkeit zu vermitteln. Tom fungierte damit als freundliche Schnittstelle zwischen Plattform und Nutzer. Sein Profil war sichtbar, ansprechbar und menschlich, was MySpace in den frühen 2000er-Jahren eine persönliche, fast intime Atmosphäre verlieh. Anders als heutige Plattformfiguren war Tom keine Marke und kein Influencer, sondern ein konstantes, vertrautes Element. Medienwissenschaftlich lässt sich „MySpace Tom“ als frühes Beispiel parasozialer Nähe lesen, die nicht auf Interaktion, sondern auf strukturelle Präsenz beruhte. Seine Rolle zeigt, wie soziale Plattformen anfangs Gemeinschaft simulierten, bevor sie zu anonymen, algorithmisch gesteuerten Räumen wurden. Tom Anderson steht damit für eine Phase des Social Webs, in der Freundschaft symbolisch, harmlos und nicht ökonomisiert war.'
    },
    ...
    title: 'Jeffree Star', 
    year: 2005,
    link: 'https://pbs.twimg.com/media/FBMzzHSUcAEluiX?format=jpg&name=small',
    images: ['2005.3.jpg'],
    desc: 'Als Myspace-Musiker etablierte sich Jeffree Star als auffällige Persönlichkeit mit extremem Styling und provokativen Fotos. Er wurde damit zu einem der bekanntesten frühen Online-Celebrities. Später baute er auf YouTube einen Kanal mit rund 15–16 Millionen Abonnent:innen auf und erreichte auf Instagram über 13 Millionen Follower, wodurch seine Marke und seine Persönlichkeit untrennbar mit seiner Online-Präsenz verbunden sind. Ikonisch ist er auch, weil Jeffree Star Cosmetics Schätzungen zufolge Umsätze in dreistelliger Millionenhöhe erzielte und damit zeigt, wie sich reine Social-Media-Reichweite in ein globales Beauty-Business verwandeln lässt – trotz und gerade wegen der zahlreichen Kontroversen, die ihn dauerhaft in der öffentlichen Diskussion halten.'
    },
...
{ 
  ...
  { 
    ...
    year: 2007,
    link: 'https://www.youtube.com/watch?v=WqSTXuJeTks',
    images: ['2007.1.png'],
    desc: '„Leave Britney Alone!“ wurde 2007 zu einem der ersten großen viralen Momente plattformübergreifender Internetkultur – insbesondere auf YouTube und MySpace. Das emotional aufgeladene Video von Chris Crocker zeigt einen tränenreichen Appell an die Öffentlichkeit, Britney Spears nach ihrem medialen Zusammenbruch in Ruhe zu lassen. Inhaltlich oszilliert der Clip zwischen Ernsthaftigkeit, Performativität und Überforderung, was ihn besonders anschlussfähig machte. Auf YouTube verbreitete sich das Video rasant, wurde parodiert, remixt und kommentiert, während MySpace als sozialer Verstärker diente, auf dem Nutzer:innen das Video in Profile einbetteten und diskutierten. Der Clip markiert einen frühen Moment, in dem persönliche Emotionen zu öffentlichem Spektakel wurden. Medienwissenschaftlich lässt sich „Leave Britney Alone!“ als Vorläufer heutiger Influencer- und Confessional-Kultur lesen. Das Video zeigt, wie frühe Social-Media-Plattformen Intimität, Öffentlichkeit und Viralität erstmals unkontrolliert miteinander verschränkten.'
  },

{ 
    id: 'instagram', 
    title: 'Instagrams Anfänge', 
    year: 2010,
  ...
  { 
    ...
    images: ['2012.2.png'],
    desc: '„Gangnam Style“ von PSY wurde 2012 zu einem der ersten wirklich globalen Social-Media-Phänomene. Der Erfolg des Songs beruhte weniger auf Sprache oder musikalischer Innovation als auf visueller Überzeichnung, Humor und klarer Wiedererkennbarkeit. Besonders der ikonische Tanz fungierte als leicht reproduzierbares Meme. Auf YouTube verbreitete sich das Video rasant und durchbrach als erstes die Milliardengrenze an Views, während Facebook, Twitter und frühe Meme-Seiten die Verbreitung weiter verstärkten. Nutzer:innen produzierten Parodien, Tanzvideos und Reaktionen, wodurch aus dem Musikvideo ein kollektives Mitmachformat wurde. Medienwissenschaftlich lässt sich „Gangnam Style“ als frühes Beispiel globaler Viralisierung lesen, bei der Plattformmechaniken, Meme-Kultur und algorithmische Sichtbarkeit zusammenwirken. Der Song markiert einen Moment, in dem Social Media erstmals zeigte, wie popkulturelle Inhalte jenseits kultureller und sprachlicher Grenzen skalieren können.'
  },
    ...
    title: 'Harlem Shake', 
    year: 2013,
    link: 'https://www.youtube.com/watch?v=8vJiSSAMNWw',
    images: ['2013.1.png'],
    desc: 'Der „Harlem Shake“ wurde 2013 zu einem der prägendsten Meme-Phänomene der frühen YouTube-Ära. Auslöser war unter anderem das Video von Joji, damals bekannt als Filthy Frank, das eine simple, klar strukturierte Dramaturgie etablierte: ein ruhiger Einstieg, gefolgt von einem abrupten Beatdrop und chaotischem Tanz. Gerade diese Wiederholbarkeit machte das Format massentauglich. Auf YouTube, Facebook und Tumblr entstanden in kürzester Zeit tausende Varianten, produziert von Schulklassen, Büros, Militärbasen und Universitäten. Der Fokus lag nicht auf Individualität, sondern auf kollektiver Teilnahme. Medienwissenschaftlich lässt sich der Harlem Shake als Paradebeispiel memetischer Replikation lesen, bei der Struktur wichtiger ist als Inhalt. Das ursprüngliche Video fungierte weniger als Werk, sondern als Bauplan. Der Harlem Shake zeigt, wie Social Media temporäre, globale Gemeinschaften erzeugen kann, die sich über Nachahmung und Gleichzeitigkeit definieren. Das Phänomen markiert eine Phase, in der Viralität vor allem durch einfache Regeln und kollektives Mitmachen entstand.'
  },
  ...
  { 
    ...
    title: 'The Dress', 
    year: 2015,
    link: 'https://pbs.twimg.com/media/B-0s75XUYAIgsvV.jpg',
    images: ['2015.1.jpg'],
    desc: 'Das blau-schwarze beziehungsweise weiß-goldene Kleid wurde 2015 auf Twitter zu einem der bekanntesten viralen Phänomene der Plattformgeschichte. Ausgangspunkt war ein einzelnes Foto, dessen uneindeutige Licht- und Farbverhältnisse zu radikal unterschiedlichen Wahrnehmungen führten. Nutzer:innen sahen entweder ein blau-schwarzes oder ein weiß-goldenes Kleid – beide Deutungen wirkten subjektiv absolut plausibel. Twitter fungierte dabei als Echtzeit-Diskursraum: Millionen Menschen beteiligten sich spontan, diskutierten, stritten und verglichen Wahrnehmungen. Der virale Effekt entstand nicht durch Emotion oder Skandal, sondern durch kognitive Irritation. Medienwissenschaftlich lässt sich das Kleid als perfektes Beispiel für partizipative Viralität lesen, bei der jeder Beitrag gleichwertig ist und persönliche Wahrnehmung zum Inhalt wird. Das Phänomen zeigt, wie Twitter kollektive Aufmerksamkeit um minimale Auslöser herum organisieren kann. Das Kleid wurde weniger als Bild rezipiert, sondern als sozialer Testfall für Subjektivität, Wahrheit und digitale Öffentlichkeit.'
  },
    ...
    year: 2016,
    link: 'https://www.youtube.com/watch?v=qFaUhLkdRPg',
    images: ['2016.2.png'],
    desc: 'Die „Mannequin Challenge“ wurde 2016 zu einem der letzten großen, klar umrissenen Social-Media-Challenges. Das Format war extrem einfach: Menschen verharren regungslos, während die Kamera durch eine Szene gleitet, meist begleitet von „Black Beatles“ von Rae Sremmurd. Diese Einfachheit machte die Challenge leicht reproduzierbar und institutionenübergreifend anschlussfähig. Besonders auffällig war, dass nicht nur Privatpersonen, sondern auch Schulen, Sportteams, Prominente und sogar Politiker teilnahmen. Die Challenge verlagerte den Fokus von individueller Performance hin zu kollektiver Choreografie. Medienwissenschaftlich lässt sich die Mannequin Challenge als Übergangsphänomen lesen: zwischen frühen Meme-Formaten und der späteren, stärker individualisierten TikTok-Kultur. Sie zeigt, wie Viralität auf Social Media über Synchronisierung, Wiederholung und soziale Teilnahme funktioniert – weniger über Originalität als über gemeinsames Stillstehen.'
  },
  ...
  { 
    ...
    year: 2019,
    link: 'https://www.instagram.com/p/BsOGulcndj-/',
    images: ['2019.1.png'],
    desc: 'Das „World Record Egg“ auf Instagram ist ein extremes Beispiel für kollektive, inhaltsleere Viralität. Der 2019 gepostete Beitrag zeigt lediglich ein braunes Ei, ohne Kontext, Persönlichkeit oder narrative Aufladung. Gerade diese Reduktion machte den Post anschlussfähig: Das Bild fungierte als gemeinsamer Gegenentwurf zu influencergetriebener Selbstdarstellung. Der virale Erfolg entstand weniger durch das Objekt selbst als durch das soziale Spiel, einen bestehenden Rekord – den von Kylie Jenner – zu übertreffen. Das Ei wurde zum Meme und zum Symbol für Plattformmechaniken, in denen Reichweite durch Beteiligung, Wiederholung und ironische Distanz entsteht. Medienwissenschaftlich lässt sich der Post als performativer Akt kollektiver Aufmerksamkeit lesen. Das „World Record Egg“ zeigt, dass Sichtbarkeit auf Instagram nicht zwingend an Inhalt oder Persönlichkeit gebunden ist, sondern an die Logik des Mitmachens.'
  },
    ...
    title: 'Area 51', 
    year: 2019,
    link: 'https://www.facebook.com/events/area-51/storm-area-51-they-cant-stop-all-of-us/885909075108287/',
    images: ['2019.1.png'],
    desc: 'Der Facebook-Post „Storm Area 51, They Can’t Stop All of Us“ aus dem Jahr 2019 begann als ironisches Event und entwickelte sich innerhalb kürzester Zeit zu einem globalen Meme. Millionen Nutzer:innen sagten zu oder zeigten Interesse, obwohl von Beginn an klar war, dass es sich um einen scherzhaften, unrealistischen Aufruf handelte. Gerade diese absurde Überzeichnung machte den Post viral. Der Erfolg des Events zeigt, wie Facebooks Event-Funktion kollektive Aufmerksamkeit bündeln kann, unabhängig von Ernsthaftigkeit oder Umsetzbarkeit. Die Aktion wurde weniger als politischer Protest verstanden, sondern als performativer Online-Witz, an dem Teilhabe wichtiger war als Handlung. Medienwissenschaftlich lässt sich der Area-51-Post als Beispiel für memetische Mobilisierung lesen, bei der Ironie, Masse und Plattformmechanik zusammenwirken. Der Post verdeutlicht, wie schnell spielerische Inhalte auf Social Media in reale Diskurse und mediale Berichterstattung kippen können.'
  },
  ...
  { 
    ...
    images: ['2021.1.png'],
    desc: 'Khaby Lame wurde während der COVID-19-Pandemie zu einer der sichtbarsten Figuren der TikTok-Kultur und entwickelte sich schnell zum meistgefolgten Creator der Plattform. Seine Videos reagieren auf überkomplizierte Life-Hacks, die er wortlos durch einfache, offensichtliche Lösungen kontert. Gerade der Verzicht auf Sprache macht seine Inhalte global verständlich und unabhängig von kulturellen Kontexten. Mit über 160 Millionen Followern auf TikTok (Stand: 2024/25) steht Khaby Lame sinnbildlich für algorithmische Popularität auf globaler Ebene. Sein Markenzeichen – der resignierte Blick, die offene Handbewegung und die stille Ironie – ist weltweit wiedererkennbar und memetisch stabil. Medienwissenschaftlich lässt sich sein Erfolg als Gegenbewegung zur Überinszenierung sozialer Medien lesen. Khaby Lame zeigt, dass maximale Reichweite nicht durch Provokation oder Lautstärke entstehen muss, sondern durch Reduktion, visuelle Klarheit und universelle Verständlichkeit. Sein Beliebtheitsgrad macht ihn zu einer der ersten wirklich globalen Social-Media-Persönlichkeiten, deren Erfolg fast vollständig ohne Sprache funktioniert.'
  },
  
  { 
    id: 'instagram', 
    title: 'Rekord-Follower', 
    year: 2024,
  ...
  { 
    id: 'instagram', 
    title: 'Politik made instagrammable', 
    year: 2025,
